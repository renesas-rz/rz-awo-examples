...
#define EP_INFO                        "\n This Example Project demonstrates CAN FD operations on Renesas RZ MCUs using 1 RZ/G board."\
...
{
    (uint16_t) BSP_IO_PORT_18_PIN_01,  ///< LED1
    (uint16_t) BSP_IO_PORT_14_PIN_02,  ///< LED2
    (uint16_t) BSP_IO_PORT_08_PIN_02,  ///< LED3
    (uint16_t) BSP_IO_PORT_08_PIN_03,  ///< LED4
};
