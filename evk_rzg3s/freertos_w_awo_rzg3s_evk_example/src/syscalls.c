 ...
 **********************************************************************************************************************/
extern void stdio_close(void);
extern int stdio_read(uint8_t *pbyBuffer, uint32_t uiCount);
extern int stdio_write(const uint8_t * pbyBuffer, uint32_t uiCount);
...
int _write (int handle, char * data, int size)
{
    ...
    return stdio_write((uint8_t*)data, (uint32_t)size);
}
...
int _read (int handle, char * data, int size)
{
    ...
    return stdio_read((uint8_t*)data, (uint32_t)size);
}
